  ...
  return (
    <div id="home" className="relative mt-3 md:mt-5">
      ...
      <div className="absolute inset-0 mx-auto md:w-2/3 flex flex-col items-center justify-center">
        ...
        <div className='flex flex-row mt-2 md:mt-6 w-2/3 md:w-1/3 justify-between'>
            <button className='btn glass text-white font-bold'>Download Resume</button>
            <button className='btn glass text-white font-bold'>Hire Me</button>
        </div>
      </div>
    </div>
  );
